...
### For Markdown Files
When creating code snippets in markdown files, always include copy button functionality:
...
<button onclick="copyCode(this)" class="copy-btn">Copy Code</button>
```

### For HTML/Web Pages
Include this JavaScript function and CSS for copy button functionality:
...
export default {
    ...
    computed: {
        buttonStyle() {
            return {
                background: this.isCopied ? '#28a745' : '#007bff',
                color: 'white',
                border: 'none',
                padding: '8px 16px',
                borderRadius: '4px',
...
Create a copy button component for Astro:
...
<div class="code-block">
    ...
    <button class="copy-btn" onclick="copyCode(this)" data-code={code}>
        Copy Code
    </button>
</div>
...
### For Documentation Sites (Docusaurus, GitBook, etc.)
